...
public class ItemsWithTooltipsExample extends Div {
  ...
  public ItemsWithTooltipsExample() { 
    ...
    Item item2 = new Item(LocalDateTime.of(2021, 8, 12, 0, 00, 00), LocalDateTime.of(2021, 8, 12, 12, 00, 00), "Item 2");
    item2.setId(2);
    item2.setTitle("<b>Tooltip for Item 2</b>");
 
    Item item3 = new Item(LocalDateTime.of(2021, 8, 13, 2, 30, 00), LocalDateTime.of(2021, 8, 14, 1, 00, 00), "No tooltip");
    item3.setId(3); 
