...
public class AddEmptyItemsExample extends VerticalLayout {
  ...
  public AddEmptyItemsExample() {
    ...
    datePicker1.addValueChangeListener(e -> newItem = createNewItem(datePicker1.getValue(), datePicker2.getValue()));
    datePicker2.addValueChangeListener(e -> newItem = createNewItem(datePicker1.getValue(), datePicker2.getValue()));
